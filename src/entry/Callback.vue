      ...
      <el-row class="row-prompt">
        <el-col :span="24">
          ...
          <el-row class="row-msg2">
            ...
            <el-col :span="22" @click.native="showFlag=true" class="a">{{$t('msgLeadingPageBBL2')}}</el-col>
          </el-row>
          <el-dialog :lock-scroll="false" title="包商银行开户须知" :visible.sync="showFlag" width="100%" style="overflow: hidden;">
