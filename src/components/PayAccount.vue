    ...
    <el-form style="background-color: #F5F5F5;">
      <el-row class="bgImg">
        <el-row>
          ...
          <el-col :span="14" class="el-col-note">薪资理财账户</el-col>
        </el-row>
        <el-row class="el-row-accno">
          <el-col :span="24">{{result.category2_card_number | formatAccIdHide}}</el-col>
        </el-row>
        <!-- <el-row>
    ...
    <el-form>
      ...
      <el-row class="el-row-1">
        <a @click="toFindMyCount">
          <el-col :span="22" class="el-col-left">交易明细查询</el-col>
      ...
      <el-row class="el-row-1">
        <a @click="toMyAccountManage">
          <el-col :span="22" class="el-col-left">工资理财</el-col>
          <el-col :span="2" class="el-col-right">
            <div><img class="enterIcon" src="../assets/image/into.png"></div>
          </el-col>
        </a>
...
export default {
  ...
  mounted: function () {
    ...
    vm.$http.post('/salary/h5/query_exist_category2_accounts').then(
      function (result) {
        vm.result.category2_card_number = result.data.category2_card_number
      }
    )
  },
  methods: {
