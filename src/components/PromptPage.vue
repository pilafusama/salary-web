  ...
  <el-container>
    ...
    <el-form>
      <el-row class="el-row-leadMsg">
        <el-col :span="24" class="el-col-leadMsg">您暂未开通薪资理财服务功能，开通本功能，您可以享受建设银行以及腾讯理财通为您提供的个性化专属薪资理财产品。</el-col>
      </el-row>
      ...
      <el-button :disabled="!checked" @click="openAccount" class="el-btn btn">{{$t('goToOpen')}}</el-button>
    </el-form>
  </el-container>
</template>
