<template>
  <el-container>
    ...
    <el-form>
        ...
        <el-col :span="24">
          ...
          <el-row class="row-msg2">
            <el-col :span="24">
              ...
              <span @click="showFlag=true" class="msg-a">{{$t('msgLeadingPage4')}}</span>
            </el-col>
          </el-row>
      ...
      <el-button :disabled="!checked" @click="openAccount" class="el-btn btn">{{$t('btnOpen2')}}</el-button>
    </el-form>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    openAccount () {
      ...
      MtaH5.clickStat('open_open_ktxgjsy_click')
